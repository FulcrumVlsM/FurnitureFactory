...
namespace FurnitureFactory.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            if (HttpContext.Request.Cookies["ifAuthorize"] != null)
            {
                string ifAuth = HttpContext.Request.Cookies["ifAuthorize"].Value;
                try
                {
            ...
            {
                ViewBag.adm = false;
                HttpContext.Response.Cookies["ifAuthorize"].Value = false.ToString();
            }
        }
